...
// File contracts/beach/BeachswapToken.sol
...
contract BeachswapToken is ERC20, ERC20Permit, Pausable, AccessControl {
    ...
    constructor(address trustedForwarder) ERC20("Beachswap Token", "BEACH") ERC20Permit("Beachswap Token") {
